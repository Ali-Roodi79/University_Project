...
class VrLevel1page extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return vrLevel1PageState();
  }

}

class vrLevel1PageState extends State<VrLevel1page> {
  double _lon = 0;
  double _lat = 0;
  double _tilt = 0;
  int _panoId = 0;
        ...
        panorama = PanoramaViewer(
          ...
          hotspots: [
            Hotspot(
              ...
              width: 90,
              height: 75,
              widget: hotspotButton(text: "Next scene", icon: Icons.open_in_browser, onPressed:(){
                _panoId++;
              }),
            ),
            Hotspot(
              ...
              width: 60.0,
              height: 60.0,
              widget: hotspotButton(icon: Icons.phone_android, onPressed: () => setState(() => Navigator.pushNamed(context, "/mobile"))),
            ),
          ],
        );
        break;
