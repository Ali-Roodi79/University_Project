...
class VrLevel1page2 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return vrLevel1PageState2();
  }
}

class vrLevel1PageState2 extends State<VrLevel1page2> {
  double _lon = 0;
  double _lat = 0;
  double _tilt = 0;
  int _panoId = 0;
          ...
          hotspots: [
            ...
            Hotspot(
              ...
              widget: hotspotButton(
                  ...
                  onPressed: () =>
                      setState(() => Navigator.pushNamed(context, "/model1"))),
            ),
            Hotspot(
              latitude: -8.510,
              longitude: -25.201,
